...
- **Data výsledků**: Excel soubory v kořenovém adresáři s názvy ve formátu `PZ{ROK}_kolo{CISLO}_*.xlsx`.
- **Mapování škol**: Soubor `skoly.csv` pro mapování kódů škol na názvy.
- **Mapování oborů**: Soubor `kkov_map.json` (generován skriptem `extract_kkov.py`) pro mapování KKOV kódů na názvy oborů.
